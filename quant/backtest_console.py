...
def run(currency, setting, rate, capital):
    ...
    # 区间推进统计
    def_stat, result_def_stat, result_end_time_stat, result_move_time_stat = engine.calculate_statistics_new(start, end)
...
if __name__ == '__main__':
    ...
    setting["btc-seg_size-30"] = {
        ...
        "slippage": 0.001,
        "open_eq_sar_step": 2,
        "open_lt_rsi": 68,  # [20, 1, 90] 0
        "open_gt_ema": 8,  # [0, 1, 30] 2
        "stop_eq_sar_step": 7,  # [1, 1, 10] 0
        "stop_gt_rsi": 0,
        "stop_gt_move": 0.1199,  # [0.01, 0.01, 0.3] 0.22
        "stop_win_per": 0.0,
        "stop_loss_per": 0.0
    }
    setting["xmr"] = {
